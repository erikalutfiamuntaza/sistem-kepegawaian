package com.mycompany.sistemkepegawaian.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mycompany.sistemkepegawaian.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mycompany.sistemkepegawaian.repository.UserRepository.USERS_BY_EMAIL_CACHE);
