...
import { PenggajianDeleteDialog } from './penggajian-delete-dialog';

describe('Penggajian Management Delete Component', () => {
  let comp: PenggajianDeleteDialog;
  let fixture: ComponentFixture<PenggajianDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PenggajianDeleteDialog);
