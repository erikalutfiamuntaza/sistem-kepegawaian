...
import { PegawaiDeleteDialog } from './pegawai-delete-dialog';

describe('Pegawai Management Delete Component', () => {
  let comp: PegawaiDeleteDialog;
  let fixture: ComponentFixture<PegawaiDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PegawaiDeleteDialog);
