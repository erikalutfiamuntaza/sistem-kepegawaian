...
import { CutiDeleteDialog } from './cuti-delete-dialog';

describe('Cuti Management Delete Component', () => {
  let comp: CutiDeleteDialog;
  let fixture: ComponentFixture<CutiDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CutiDeleteDialog);
