...
import { AbsensiDeleteDialog } from './absensi-delete-dialog';

describe('Absensi Management Delete Component', () => {
  let comp: AbsensiDeleteDialog;
  let fixture: ComponentFixture<AbsensiDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AbsensiDeleteDialog);
